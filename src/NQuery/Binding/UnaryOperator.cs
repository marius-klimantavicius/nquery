...
namespace NQuery.Binding
{
    internal static class UnaryOperator
    {
        ...
        {
            new UnaryOperatorSignature(UnaryOperatorKind.Identity, typeof(int), typeof(int)), new UnaryOperatorSignature(UnaryOperatorKind.Identity, typeof(uint), typeof(uint)), new UnaryOperatorSignature(UnaryOperatorKind.Identity, typeof(long), typeof(long)), new UnaryOperatorSignature(UnaryOperatorKind.Identity, typeof(ulong), typeof(ulong)), new UnaryOperatorSignature(UnaryOperatorKind.Identity, typeof(float), typeof(float)), new UnaryOperatorSignature(UnaryOperatorKind.Identity, typeof(double), typeof(double)), new UnaryOperatorSignature(UnaryOperatorKind.Identity, BuiltInOperators.DecimalUnaryIdentityMethod),
        };

        private static readonly UnaryOperatorSignature[] BuiltInNegationSignatures =
        {
            new UnaryOperatorSignature(UnaryOperatorKind.Negation, typeof(int), typeof(int)), new UnaryOperatorSignature(UnaryOperatorKind.Negation, typeof(long), typeof(long)), new UnaryOperatorSignature(UnaryOperatorKind.Negation, typeof(float), typeof(float)), new UnaryOperatorSignature(UnaryOperatorKind.Negation, typeof(double), typeof(double)), new UnaryOperatorSignature(UnaryOperatorKind.Negation, BuiltInOperators.DecimalUnaryNegationMethod),
        };

        private static readonly UnaryOperatorSignature[] BuiltInComplementSignatures =
        {
            new UnaryOperatorSignature(UnaryOperatorKind.Complement, typeof(int), typeof(int)), new UnaryOperatorSignature(UnaryOperatorKind.Complement, typeof(uint), typeof(uint)), new UnaryOperatorSignature(UnaryOperatorKind.Complement, typeof(long), typeof(long)), new UnaryOperatorSignature(UnaryOperatorKind.Complement, typeof(ulong), typeof(ulong)),
        };
