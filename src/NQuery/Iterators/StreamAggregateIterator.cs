...
namespace NQuery.Iterators
{
    internal sealed class SegmentIterator : Iterator
    {
        ...
        public SegmentIterator(Iterator input, IEnumerable<RowBufferEntry> groupEntries, ImmutableArray<IComparer> comparers)
        {
            _input = input;
        ...
        public override bool Read()
        {
            ...
            if (!CheckIfCurrentRowIsInSameGroup())
                _rowBuffer.Array[0] = 0;
            else
                _rowBuffer.Array[0] = 1;
